...
`;
    ...
    return `https://github.com/ignasga/Brainal/issues/new?title=${encodedTitle}&body=${encodedBody}`;
  };
    ...
    <div className="tab-content">
      ...
      <div className="section">
        ...
        <div className="report-section">
          <p>Found a bug? Help us improve Brainal by reporting this error on GitHub.</p>
          <button
